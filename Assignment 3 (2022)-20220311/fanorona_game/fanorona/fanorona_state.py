...
class FanoronaState(object):  # TODO: Link it to the core state.

    def __init__(self, board, next_player=-1, boring_limit=50):
        """The State of the Fanorona Game. It contains information regarding the game such as:
        ...
        self.score = {-1: 0, 1: 0}
        self.on_board = {-1: 22, 1: 22} #this is a dicitonary
